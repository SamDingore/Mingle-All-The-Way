                    ...
                    if ( typeof data != 'undefined'){
                        if ( typeof data['warning'] != 'undefined' && data['warning'] ){
                            ...
                            if (data['use_chat'] && data['use_chat'] == 'promoted'){
                                ...
                                OW.Mailbox.usersCollection.add(data);
                                OW.trigger('mailbox.open_dialog', {convId: data['convId'], opponentId: data['opponentId'], mode: 'chat', 'isFriend': data['isFriend'], 'isGoldenMessage': data['isGoldenMessage'], 'isMyGoldenMessage': data['isMyGoldenMessage']});
                            }
                        }
                    }
